...
- **[Memory Import Processor](./memport.md):** Documentation for the modular
  DEVORA.md import feature using @file.md syntax.
...
- **Prompt engineering:** Constructing effective prompts for the Gemini model,
  ...
  instructional context from `DEVORA.md` files.
...
`DEVORA.md` files that provide context to the model. It searches for these files
...
`refresh` the content of loaded `DEVORA.md` files.
