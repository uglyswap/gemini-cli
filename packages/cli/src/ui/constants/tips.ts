...
export const INFORMATIVE_TIPS = [
  ...
  'Show Devora status in the terminal window title (/settings)...',
  ...
  'Create a project-specific DEVORA.md file with /init...',
  ...
  'Reload instructional context from DEVORA.md files with /memory refresh...',
  'List the paths of the DEVORA.md files in use with /memory list...',
