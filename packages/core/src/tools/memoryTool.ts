...
export const DEFAULT_CONTEXT_FILENAME = 'DEVORA.md';
export const MEMORY_SECTION_HEADER = '## Devora Added Memories';

// This variable will hold the currently configured filename for DEVORA.md context files.
