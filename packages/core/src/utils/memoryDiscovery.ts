...
/**
 * Traverses upward from startDir to stopDir, finding all DEVORA.md variants.
 *
...
/**
 * Loads hierarchical DEVORA.md files and concatenates their content.
...
export async function loadServerHierarchicalMemory(
  ...
  if (filePaths.length === 0) {
    if (debugMode)
      logger.debug('No DEVORA.md files found in hierarchy of the workspace.');
